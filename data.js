window.GAME_SLIDES = [
    ...
    // ??? SLIDE 2: CHAPTER ?????????????????????????????????????????
    {
        ...
        warning: "Nejprve shlédni úvodní video, teprve pak otevři první spis. Až ho prostuduješ, podej hlášení!",
        buttonText: "PODAT HLÁŠENÍ"
    },
    ...
    // ??? SLIDE 8: AUDIO ?????????????????????????????????????????
    {
        ...
        infoText: "Nyní otevři spis a pokračuj v pátrání. Až spis prostuduješ, podej hlášení.",
        buttonText: "PODAT HLÁŠENÍ"
    },
    ...
    // ??? SLIDE 26: INTERLUDE ?????????????????????????????????????????
    {
        ...
        hints: {
            textHints: [
                ...
                "Napiš email na analytické oddělení a počkej na odpověď.","Emailová adresa na analytické oddělení je analytikahvozdna@gmail.com","Až ti dokument přijde, prostuduj ho, zadej kód z dokumentu a pokračuj ve vyplňování hlášení.","Kód z dokumentu je 202603555."
            ],
            audioHintCount: 1
        }
    },
    ...
    // ??? SLIDE 37: CHAPTER ?????????????????????????????????????????
    {
        ...
        warning: "Nejprve shlédni úvodní video, teprve pak otevři šestý spis. Až ho prostuduješ, podej hlášení.",
        buttonText: "PODAT HLÁŠENÍ"
    },
    ...
    // ??? SLIDE 55: OT?ZKA TYP 7 ?????????????????????????????????????????
    {
        ...
        keywordAnswers: ["mřela", "mrt", "zesnul", "nežij"],
    ...
    // ??? SLIDE 58: CHAPTER ?????????????????????????????????????????
    {
        ...
        warning: "Shlédni úvodní video a pak otevři spis. Až ho prostuduješ, podej hlášení.",
        buttonText: "PODAT HLÁŠENÍ"
    },
    ...
    // ??? SLIDE 63: OT?ZKA TYP 3 ?????????????????????????????????????????
    {
        ...
        id: 63,
        questionType: 3,
        text: "Pospíšilovi chodily peníze pouze z jednoho zdroje. Jaká je pracovní pozice muže, který mu pravidelně posílal platby?",
    ...
    // ??? SLIDE 64: OT?ZKA TYP 7 ?????????????????????????????????????????
    {
        type: "question",
        id: 64,
        questionType: 7,
        text: "Našels na výpise společnosti CLEAN s.r.o. nějaké zajímavé jméno?",
        keywordAnswers: ["STA\u0147KOV", "N\u011aMCOV"],
        correctAnswer: "VENDULA STA\u0147KOV\u00c1 N\u011aMCOV\u00c1",
        hints: {
            textHints: [
    ...
    // ??? SLIDE 65: OT?ZKA TYP 2 ?????????????????????????????????????????
    {
        ...
        hints: {
            textHints: [
                "Zkus se znovu podívat do databáze hovorů a prověř číslo, ze kterého bylo telefonováno Barboře Hladíkové. Jméno Venduly Staňkové Němcové tam figuruje a určitě z toho můžeme odvodit i jména jejich rodičů.",
    ...
    // ─── SLIDE 68: AUDIO ───────────────────────────────────────────────
    {
        ...
        infoText: "Nyní pokračuj v prostudování třetího spisu. Pak podej hlášení.",
        buttonText: "Pokračovat"
    },
    ...
    // ??? SLIDE 70: OT?ZKA TYP 3 ?????????????????????????????????????????
    {
        ...
        hints: {
            textHints: [
                "Na druhé straně jsou rozházená písmena. Stačí vyškrtat písmena, která dávají jména Josef Pospíšil a Lukáš Havel, a zbydou nám písmena, která dohromady tvoří jméno třetí osoby na fotografii. To dá celkem rozum, ne?",
    ...
    // ??? SLIDE 72: OT?ZKA TYP 3 ?????????????????????????????????????????
    {
        ...
        hints: {
            textHints: [
                ...
                "No jasně, byla v novinách. Budeme ji muset vyluštit. Vyškrtáváme slova, která jsou pod tím v nabídce. To, co nám zbyde, pak utvoří chybějící část tajenky.",
                "Chybějící část tajenky podle mě bude \"každé čtvrté písmeno\".",
    ...
    // ??? SLIDE 74: OT?ZKA TYP 3 ?????????????????????????????????????????
    {
        ...
        hints: {
            textHints: [
                ...
                "No jasně, je to v kalendáři a je to označené jako HESLO PRO STRAKU.",
    ...
    // ??? SLIDE 85: OT?ZKA TYP 7 ?????????????????????????????????????????
    {
        ...
        hints: {
            textHints: ["Když si v databázi telefonní číslo rozklikneš, zjistíš, komu patří.","Telefonní číslo patří Marii Tůmové"],
            audioHintCount: 0
        }
    },
    ...
    // ??? SLIDE 94: OT?ZKA TYP 2 ?????????????????????????????????????????
    {
        ...
        id: 94,
        questionType: 2,
        text: "Na zadní straně skartovaného dokumentu si někdo zkoušel hru náctiletých zvanou FLAMES. Napiš obě křestní jména, kterých se tato hra týkala.",
        fieldCount: 2,
    ...
    // ??? SLIDE 95: OT?ZKA TYP 3 ?????????????????????????????????????????
    {
        ...
        acceptedAnswers: ["ERRE URET LNID JIKXG","ERREURETLNIDJIKXG"],
        hints: {
        ...
        "Ať to zkouším, jak to zkouším, tak to nic smysluplného nedává. Vyšlo mi ERRE URET LNID JIKXG."
            ],
            audioHintCount: 0
        }
    },
    ...
    // ??? SLIDE 101: INTERLUDE ?????????????????????????????????????????
    {
        ...
        buttonText: "POKRAČOVAT",
        hints: {
            textHints: ["Napiš na emailovou adresu odboru kriminalistické techniky a expertíz.","Kontakt najdeš v adresáři, který máš k dispozici.","Emailová adresa je odborkte@gmail.com","Počkej, až ti přijde dokument, prostuduj ho, opiš z něj kód a pokračuj ve vyplňování hlášení.","Kód pro pokračování je 202503922."],
            audioHintCount: 0
        }
    },
    // ??? SLIDE 102: INTERLUDE ?????????????????????????????????????????
    ...
    // ??? SLIDE 108: OT?ZKA TYP 6 ?????????????????????????????????????????
    {
        ...
        id: 108,
        questionType: 6,
        text: "Máme obvinit Aleše Zlámala? Jsme přesvědčeni o jeho vině?",
        options: ["ANO", "NE"],
        hints: {
            textHints: [],
            audioHintCount: 0
    ...
    // ??? SLIDE 109: INTERLUDE ?????????????????????????????????????????
    {
        ...
        link: {
            url: "https://drive.google.com/file/d/1glsN3CaUBHuwm5ehw9WrDns0_LLASMDL/view?usp=drive_link",
            label: "[ OTEVŘÍT EMAIL ]"
        },
        hints: {
            textHints: [],
    ...
    // ??? SLIDE 110: OT?ZKA TYP 3 ?????????????????????????????????????????
    {
        ...
        hints: {
            textHints: [
                ...
                "Ty verše pod šifrou jistě odkazují na hudební dílo, které jsme už měli možnost slyšet.",
                "Možná bych zkusil zjistit, z jaké písně jsou ty verše. Určitě nám to pomůže s tím posunem.",
                "Růžový verš je z písně \"Můj syn bude král\", modrý verš je z písně \"Za všechno můžem my\", zelený verš z písně \"Thyron padne\" a poslední verš z písně z písně \"Narodil se Bůžek\".",
                "Co se takhle zaměřit na pořadí písní v dramatu?",
                "Pořadí písně podle mě určuje, o kolik pozic je třeba posunout každé písmeno. Jenže na jakou stranu?",
                "Co takhle posouvat podle šipek, které tam jsou?",  
    ...
    // ??? SLIDE 111: INTERLUDE ?????????????????????????????????????????
    {
        ...
        link: {
            url: "https://drive.google.com/file/d/1T7OF4MAYJEksMLI9XcFY7l732l2vLEfY/view?usp=drive_link",
    ...
    // ??? SLIDE 114: OT?ZKA TYP 5 ?????????????????????????????????????????
    {
        ...
        id: 114,
        questionType: 5,
        text: "Byla v době první vraždy Barbora Hladíková přítomná v okolí místa činu?",
        yesNoCorrect: "yes",
        hints: {
    ...
    // ??? SLIDE 115: OT?ZKA TYP 7 ?????????????????????????????????????????
    {
        ...
        hints: {
            textHints: ["Podívej se na lokalizaci mobilu.", "Mapa ti napoví, kde se v tu dobu nacházela.","Nacházela se na Vršovickém hřbitově."],
            audioHintCount: 0
        }
    },
    // ??? SLIDE 116: OT?ZKA TYP 7 ?????????????????????????????????????????
    {
        ...
        hints: {
            textHints: ["O tom, co se ten den a čas mělo na hřbitově konat, jsme už někde četli, ne?", "Nebylo to ve Vršovickém obzoru?","V těch novinách se psalo o pietní akci na počest Anny Zlámalové."],
            audioHintCount: 0
        }
    },
    ...
    // ??? SLIDE 119: OT?ZKA TYP 7 ?????????????????????????????????????????
    {
        ...
        hints: {
            textHints: [
                ...
                "Podívej se, kdy se signál mobilu Barbory Hladíkové přestal pohybovat a byl lokalizován na onom inkriminovaném místě.","Podle lokalizace to bylo v 7:00."
            ],
            audioHintCount: 0
        }
    },
